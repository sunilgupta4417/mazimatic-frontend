      ...
      t.slideHandler = function (e) {
        ...
        if (r) {
          ...
          (b = w),
            ...
            !i && w + h >= s && (b = s - h),
            (m = T(a(a({}, e), {}, { slideIndex: w }))),
            (S = T(a(a({}, e), {}, { slideIndex: b }))),
            i || (m === S && (w = b), (m = S)),
          ...
          return (
            S ||
              (((0 === u && ("right" === R || "down" === R)) ||
                ...
                (!g(t) && ("left" === R || "up" === R))) &&
                ((z = w.swipeLength * d),
                !1 === f && p && (p(R), (j.edgeDragged = !0)))),
            !h && O && (O(R), (j.swiped = !0)),
            (E = i ? x + z * (_ / P) * M : l ? x - z * M : x + z * M),
            s && (E = x + z * M),
            (j = a(
              a({}, j),
              {},
              {
                touchObject: w,
                swipeLeft: E,
                trackStyle: k(a(a({}, t), {}, { left: E })),
              }
            )),
            Math.abs(w.curX - w.startX) < 0.8 * Math.abs(w.curY - w.startY)
              ? j
              : (w.swipeLength > 10 && ((j.swiping = !0), c(e)), j)
          );
        }
      };
