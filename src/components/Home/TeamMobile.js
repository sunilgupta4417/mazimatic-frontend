...
const TeamMobile = () => {
  return (
    <section id="TeamMobile">
        <img src="./assets/images/team-mobile-bg.svg" className="team-mobile-bg" />
        <div className="row">
		 ...
		 {/* <div className="col-6 top-member mt-5 text-center">
           <img src="assets/images/navin.png" style={{ "border":"2px solid #FFFFFF" }} />
            ...
            <p>CSO/Co-founder</p>
             <div className='row'>
                <div className='col-md-12 text-center'>
                   <a href='https://www.linkedin.com/in/mr-navin-kejriwal-17113315' target='_blank'><img src='assets/images/icons/linkedin.png' className='social' /></a>
       ...
       <div className="col-6 top-member text-center">
        ...
        <div className="col-6 top-member mt-5 text-center">
          <img src="assets/images/uddalak.jfif" />
            ...
            <div className='row'>
                <div className='col-md-12 text-center'>
                <a href='https://www.linkedin.com/in/uddalak-das-crypto-nft-defi/' target='_blank'><img src='assets/images/icons/linkedin.png' className='social' /></a> </div>
            </div>
          </div>
         </div>
