    ...
    <section id="Roadmap">
      ...
      <div className="row">
        <div className="col-md-12 text-center">
          ...
          <h3>
            HOW WE ARE GOING
            <br /> TO GO ABOUT <span>ACHIEVING THIS?</span>
          </h3>
        </div>
      </div>
          ...
          <Slider ref={(c) => setSliderRef(c)} {...settings}>
            ...
            <div className="roadmap-item">
              ...
              <p>
                ...
                />
                ICO and listing on Multiple exchanges including Huobi, OKKEX and
                Gate.io.
              </p>
              <p>
                <img
              ...
              <p>
                ...
                />
                Official App Launch - MaziMatic (Apple, Android, Windows and
                VR).
              </p>
              <p>
                <img
            ...
            <div className="roadmap-item">
              ...
              <p>
                ...
                />
                Selected NFT's to partner as an Avatar in the gameplay.
              </p>
            </div>
